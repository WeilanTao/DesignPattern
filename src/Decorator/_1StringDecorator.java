...
/**
 * String is a final class that we can't extend from it directly;
 *
 * Alternatively, we can include a field of string in our class
 */
...
public class _1StringDecorator {
