...
class MyStringBuidler{
    private  StringBuilder sb ;

    public MyStringBuidler() {
        sb = new StringBuilder();
    }

    public MyStringBuidler(String s) {
        this.sb = new StringBuilder(s);
    }

    public  MyStringBuidler concat(String str){
        return new MyStringBuidler( sb.toString().concat(str));
    }

    public MyStringBuidler appendLine(String str){
    ...
    public MyStringBuidler append(String str) {
        sb.append(str);
        return this;
    }
...
////////////////////////////////////////////////////////////////////
public class _4AdapterDecorator {
    public static void main(String[] args) {
        MyStringBuidler msb = new MyStringBuidler();
